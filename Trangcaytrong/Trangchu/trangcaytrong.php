...
<head>
	...
	<script type="text/javascript" src="./trangcaytrong.js"></script>
</head>
<body>
	<!-- header-->
	 <header>
	...
	<div class="search-container" style="float: right;margin-right: 100px;">
	 ...
	 <div class="row" style="margin-top: 50px;margin-bottom: 20px;">
	    	...
	    	<center>
		    	<div class="containers" >
				  ...
				  <div>
				  	...
				  	<hr>
				  	<div style="font-size: 30px;">Bài viết nổi bật</div><br>
				  	<!-- phần tin nổi bật -->
				  	<div id="tinnong">
				  		<?php
	    ...
	    <div class="col-sm-9"  style="background-color:lavenderblush;">
	    	<div class="row list">
	    		<?php
	    		if(isset($_GET['idDmsp'])){
	    		$a1=$_GET['idDmsp'];
                $a = "SELECT * FROM tb_sanpham where IdDMSP='$a1' ORDER BY Id DESC" ;}
                else{
                	$a = "SELECT * FROM tb_sanpham ORDER BY Id DESC";
                }
                ...
                foreach ($result as $row) {
				  echo'<div class="col-sm-4">
				  	<div class="conten">
				  		<img src="'.$row['AnhMoTa'].'">
				  		<a href="./trangvesanpham.php?idSP='.$row['Id'].'"><center>'.$row['Name'].'</center></a>
